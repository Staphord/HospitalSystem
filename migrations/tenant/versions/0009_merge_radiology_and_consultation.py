...
Revises: 0006_add_radiology_reports, 0008_alter_visits_patient_id_to_uuid
...
down_revision: Union[str, None] = ('0006_add_radiology_reports', '0008_alter_visits_patient_id_to_uuid')
