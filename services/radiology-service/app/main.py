...
app = FastAPI(
    ...
    description="Radiology service for the hospital management system",
    version="1.0.0",
    docs_url=docs_url,
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "radiology-service"}

app.include_router(service_router, prefix="/api/v1/radiology")
